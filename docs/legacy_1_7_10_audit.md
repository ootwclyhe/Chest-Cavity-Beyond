...
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/CapabilityManager.java:3` -> `import net.neoforged.neoforge.capabilities.ItemCapability;`
- `src/main/java/net/zhaiji/chestcavitybeyond/datagen/ItemModelProvider.java:4` -> `import net.neoforged.neoforge.common.data.ExistingFileHelper;`
- `src/main/java/net/zhaiji/chestcavitybeyond/datagen/ItemModelProvider.java:10` -> `public class ItemModelProvider extends net.neoforged.neoforge.client.model.generators.ItemModelProvider {`
- `src/main/java/net/zhaiji/chestcavitybeyond/datagen/DamageTypeTagsProvider.java:9` -> `import net.neoforged.neoforge.common.data.ExistingFileHelper;`
- ... 其余 64 条省略
...
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/OrganManager.java:18` -> `if (context.entity() instanceof Player player) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/ChestCavityTypeManager.java:850` -> `if (entity instanceof AbstractSkeleton) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/ChestCavityTypeManager.java:854` -> `if (entity instanceof Zombie || entityType.is(EntityTypeTags.UNDEAD)) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/ChestCavityTypeManager.java:858` -> `if (entity instanceof AbstractFish) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/ChestCavityTypeManager.java:865` -> `|| entity instanceof WaterAnimal`
- `src/main/java/net/zhaiji/chestcavitybeyond/manager/ChestCavityTypeManager.java:871` -> `if (entity instanceof Animal || entityType.getCategory() == MobCategory.CREATURE) {`
...
- `src/main/java/net/zhaiji/chestcavitybeyond/effect/FurnacePowerEffect.java:17` -> `if (!livingEntity.level().isClientSide() && livingEntity instanceof Player player) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:197` -> `if (!event.getLevel().isClientSide() && !event.loadedFromDisk() && event.getEntity() instanceof LivingEntity entity) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:200` -> `if (entity instanceof ServerPlayer player) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:236` -> `if (stack.is(InitItem.CHEST_OPENER.get()) && event.getTarget() instanceof LivingEntity) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:253` -> `if (instance instanceof IMobEffectInstance mobEffectInstance && mobEffectInstance.isHarmful()) {`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:274` -> `boolean isWaterPotion = source.getDirectEntity() instanceof ThrownPotion potion && potion.getItem().getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).is(Potions.WATER);`
- `src/main/java/net/zhaiji/chestcavitybeyond/event/CommonEventHandler.java:315` -> `if (source.getDirectEntity() instanceof LivingEntity sourceEntity && source.getEntity() == sourceEntity) {`
- ... 其余 33 条省略
